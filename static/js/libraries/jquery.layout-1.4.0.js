...
,	panes: { // default options for 'all panes' - will be overridden by 'per-pane settings'
	...
	,	togglerLength_open:		200			// Length = WIDTH of toggler button on north/south sides - HEIGHT on east/west sides
	,	togglerLength_closed: 	300			// 100% OR -1 means 'full height/width of resizer bar' - 0 means 'hidden'
...
,	initResizable = function (panes) {
		...
		var resizePanes = function (evt, ui, pane, resizingDone) {
			...
			Blockly.fireUiEventNow(window, 'resize');  // AJL: Added for blockly
		};
	}
