...
Blockly.Block.prototype.fill = function(workspace, prototypeName) {
  ...
  /** @type {boolean|undefined} */
  this.inputsInlineDefault = this.inputsInline;  // AJL: V2 change
};
...
// AJL: New to V2 this seems to have replaced interpolateMsg functions (3).
/**
...
// AJL: These were in the old version but not the new.
/**
