...
Blockly.BlockSvg = function () {
    ...
    //this.updateMovable();    // AJL: Removed in new version.
};
...
Blockly.BlockSvg.prototype.initSvg = function () {
    ...
    this.updateColour();
    this.updateMovable();
    // AJL: This if changed in new version.
    ...
    if (goog.isFunction(this.onchange) && !this.eventsInit_) {
        this.onchangeWrapper_ = Blockly.bindEvent_(this.workspace.getCanvas(), 'blocklyWorkspaceChange', this, this.onchange);
    }
...
Blockly.BlockSvg.prototype.setParent = function (newParent) {
    ...
    Blockly.Field.startCache();  // AJL: new
    Blockly.BlockSvg.superClass_.setParent.call(this, newParent);
    Blockly.Field.stopCache();  // AJL: new
 ...
 * @const
 */
Blockly.BlockSvg.INLINE_PADDING_Y = 6;  // AJL: Changed from 5 to 8. Back to 5
 ...
 * @const
 */
Blockly.BlockSvg.CORNER_RADIUS = 5;  // AJL:  Changed from 8 to 10 to 5.
/**
 ...
 * @const
 */
Blockly.BlockSvg.NOTCH_PATH_LEFT = 'l 6,4 2,0 6,-4'; // AJL: original 'l 6,4 3,0 6,-4'
/**
 * SVG path for drawing next/previous notch from left to right with
 * highlighting.
 * @const
 */
Blockly.BlockSvg.NOTCH_PATH_LEFT_HIGHLIGHT = 'l 6.5,4 1,0 6.5,-4';  // AJL: original 'l 6,4 2,0 6,-4'
/**
 * SVG path for drawing next/previous notch from right to left.
 * @const
 */
Blockly.BlockSvg.NOTCH_PATH_RIGHT = 'l -9,4 1,0 -9,-4';  // AJL: original 'l -6,4 -3,0 -6,-4'
/**
...
Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL = 'v 6.5 m -' +
    (Blockly.BlockSvg.TAB_WIDTH * 0.97) + ',3 q -' +           // AJL: old 2.5
    (Blockly.BlockSvg.TAB_WIDTH * 0.05) + ',10 ' +
    (Blockly.BlockSvg.TAB_WIDTH * 0.3) + ',9.5 m ' +           // AJL: old 10
    (Blockly.BlockSvg.TAB_WIDTH * 0.67) + ',-1.9 v 1.4';       // AJL: old -2.5 v 1.5
...
Blockly.BlockSvg.TOP_LEFT_CORNER_START_HIGHLIGHT_LTR =
    'm 0.5,' + (Blockly.BlockSvg.CORNER_RADIUS - 0.5);   // AJL: old was 'm 1,' + (Blockly.BlockSvg.CORNER_RADIUS - 1);
/**
...
Blockly.BlockSvg.TOP_LEFT_CORNER_HIGHLIGHT =
    'A ' + (Blockly.BlockSvg.CORNER_RADIUS - 0.5) + ',' +   // AJL: old - 1)
    (Blockly.BlockSvg.CORNER_RADIUS - 0.5) + ' 0 0,1 ' +    // AJL: old - 1)
    Blockly.BlockSvg.CORNER_RADIUS + ',0.5';                // AJL: old ,1';
/**
...
Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_RTL =
    ...
    (Blockly.BlockSvg.CORNER_RADIUS + 0.5);
// AJL: above old had 1s instead of 0.5s
/**
 * SVG path for drawing highlight on the bottom-left corner of a statement
 * input in LTR.
 * @const
...
// AJL: below is different from old version.
/**
...
Blockly.BlockSvg.prototype.disposeUiEffect = function () {
    ...
    this.workspace.options.svg.appendChild(clone);  // AJL: old was Blockly.svg.appendChild(clone);
    clone.bBox_ = clone.getBBox();
    // Start the animation.
    Blockly.BlockSvg.disposeUiStep_(clone, this.RTL, new Date(),
        this.workspace.scale);
    // AJL: above 1 line replaces these 2 lines:
