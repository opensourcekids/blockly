...
Blockly.Blocks['numbers_arithmetic'] = {
    ...
    init: function () {
        ...
        var OPERATORS = [
            [Blockly.Blocks.numbers.SYMBOL_ADDITION, 'ADD'],
            [Blockly.Blocks.numbers.SYMBOL_SUBTRACTION, 'MINUS'],
            [Blockly.Blocks.numbers.SYMBOL_MULTIPLICATION, 'MULTIPLY'],
            [Blockly.Blocks.numbers.SYMBOL_DIVISION, 'DIVIDE'],
            ["//", 'DIVIDE_FLOOR'],
            [Blockly.Blocks.numbers.SYMBOL_POWER, 'POWER'],
            [Blockly.Blocks.numbers.SYMBOL_MODULUS, 'MODULUS']
        ];
        this.setHelpUrl(Blockly.Msg.NUMBERS_ARITHMETIC_HELPURL);
        this.setColour();//Blockly.Blocks.numbers.HUE);
...
Blockly.Blocks['numbers_something_equals_tovar'] = {
    init: function () {
        var OPERATORS =
            [
                [Blockly.Blocks.numbers.SYMBOL_PLUS_EQUALS, 'ADD'],
                [Blockly.Blocks.numbers.SYMBOL_MINUS_EQUALS, 'MINUS'],
                [Blockly.Blocks.numbers.SYMBOL_TIMES_EQUALS, 'MULTIPLY'],
                [Blockly.Blocks.numbers.SYMBOL_DIVIDE_EQUALS, 'DIVIDE']
            ];
