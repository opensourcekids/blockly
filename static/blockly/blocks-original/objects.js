...
var OBJECTS_HUE = 290;
var OBJECTS_USE_COMMA_FOR_CALLSHELL = true;
...
Blockly.Blocks['objects_callnoreturn'] = {
    ...
    onchange: function () {
        ...
        if (this.creator != null) {
            //this.getValue
            console.log(this.getVariblesOfClass());
    ...
    getVariblesOfClass: function () {
        ...
        for (var x = 0; x < blocks.length; x++) {
            if (blocks[x].type == 'variables_set') {
                ...
                if (value == null){
                    return 'change me';
                } else if (value.type == 'objects_callshell') {
    ...
    setParameters: function (params) {
        ...
        for (var i = 0; i < my_params.length; i++) {
            ...
            var input = this.appendValueInput('ARG' + i)
                .setAlign(Blockly.ALIGN_RIGHT);
            if (OBJECTS_USE_COMMA_FOR_CALLSHELL) {
                if (i != 0) {
                    input.appendField(', ');
                }
            } else {
