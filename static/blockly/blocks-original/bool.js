...
goog.provide('Blockly.Blocks.bool');

goog.require('Blockly.Blocks');
//goog.require('Blockly.Hue');


//Blockly.Hue.BOOL = 140;
    ...
    */
        ...
        if (this.elseCount_) {
            this.appendStatementInput('ELSE')
                .appendField('   ' + Blockly.Msg.CONTROLS_IF_MSG_ELSE + Blockly.Blocks.colon_());
            ...
            switch (clauseBlock.type) {
                case 'controls_if_elseif':
                    ...
                    var ifInput = this.appendValueInput('IF' + this.elseifCount_)
                        .setCheck([Blockly.Type.BOOL, Blockly.Type.NONE])
                        .appendField('   ' + Blockly.Msg.CONTROLS_IF_MSG_ELSEIF);
                    var ifColon = this.appendDummyInput('COLON' + this.elseifCount_)
                        .appendField(Blockly.Blocks.colon_());
                ...
                case 'controls_if_else':
                    this.elseCount_++;
                    //this.appendDummyInput('ELSE_TEXT')
...
//             ['BOOL', Blockly.Type.BOOL, Blockly.ALIGN_RIGHT],
//             Blockly.ALIGN_RIGHT);
...
Blockly.Blocks['logic_boolean'] = {
    ...
    init: function () {
        ...
        this.block_type = Blockly.Type.BOOL;//'Boolean';
    }
};
...
Blockly.Blocks['bool_cast'] = {
    init: function() {
        ...
        this.appendValueInput("CAST")
            .setCheck([Blockly.Type.NUMBER, Blockly.Type.FLOAT, Blockly.Type.STR, Blockly.Type.BOOL])
        this.appendDummyInput()
