...
Blockly.Python['lists_empty_list'] = function (block) {
    // Create an empty list.
...
Blockly.Python['lists_create_with'] = function (block) {
    ...
    for (var n = 0; n < block.itemCount_; n++) {
        code[n] = Blockly.Python.valueToCode(block, 'ADD' + n, Blockly.Python.ORDER_NONE) || '';
    }
    //if (code.length == 1) {
    //    code = '(' + code[0] + ', )';
    //} else {
...
Blockly.Python['lists_repeat'] = function (block) {
    ...
    var argument0 = Blockly.Python.valueToCode(block, 'ITEM', Blockly.Python.ORDER_NONE) || 'None';
    var argument1 = Blockly.Python.valueToCode(block, 'NUM', Blockly.Python.ORDER_MULTIPLICATIVE) || '0';
...
Blockly.Python['lists_concat'] = function (block) {
    // Create a list with one element repeated.
    var argument0 = Blockly.Python.valueToCode(block, 'LIST1', Blockly.Python.ORDER_NONE);
    var argument1 = Blockly.Python.valueToCode(block, 'LIST2', Blockly.Python.ORDER_MULTIPLICATIVE);
    var code = argument0 + " + " + argument1;
    return [code, Blockly.Python.ORDER_MULTIPLICATIVE];
};
...
Blockly.Python['lists_indexOf'] = function (block) {
    ...
    var argument0 = Blockly.Python.valueToCode(block, 'FIND', Blockly.Python.ORDER_NONE) || '[]';
    var argument1 = Blockly.Python.valueToCode(block, 'VALUE', Blockly.Python.ORDER_MEMBER) || '\'\'';
    var code;
...
Blockly.Python['lists_getIndex'] = function (block) {
    ...
    var at = Blockly.Python.valueToCode(block, 'AT', Blockly.Python.ORDER_UNARY_SIGN) || '1';
    var list = Blockly.Python.valueToCode(block, 'VALUE', Blockly.Python.ORDER_MEMBER) || '[]';
...
Blockly.Python['lists_insert'] = function (block) {
    var value_list = Blockly.Python.valueToCode(block, 'LIST', Blockly.Python.ORDER_ATOMIC);
    var value_insert_item = Blockly.Python.valueToCode(block, 'INSERT_ITEM', Blockly.Python.ORDER_ATOMIC);
    var value_position = Blockly.Python.valueToCode(block, 'POSITION', Blockly.Python.ORDER_ATOMIC);

    var code = value_list + '.insert(' + value_position + ', ' + value_insert_item + ')\n';
...
Blockly.Python['lists_remove'] = function (block) {
    var value_list = Blockly.Python.valueToCode(block, 'LIST', Blockly.Python.ORDER_ATOMIC);
    var value_item = Blockly.Python.valueToCode(block, 'ITEM', Blockly.Python.ORDER_ATOMIC);
    var code = value_list + '.remove(' + value_item + ')\n';
...
Blockly.Python['lists_index'] = function (block) {
    var value_list = Blockly.Python.valueToCode(block, 'LIST', Blockly.Python.ORDER_ATOMIC);
    var value_item = Blockly.Python.valueToCode(block, 'ITEM', Blockly.Python.ORDER_ATOMIC);
    var code = value_list + '.index(' + value_item + ')';

    return [code, Blockly.Python.ORDER_NONE];
};

// https://blockly-demo.appspot.com/static/demos/blockfactory/index.html#cu5u5y
Blockly.Python['lists_count'] = function (block) {
    var value_list = Blockly.Python.valueToCode(block, 'LIST', Blockly.Python.ORDER_ATOMIC);
    var value_item = Blockly.Python.valueToCode(block, 'ITEM', Blockly.Python.ORDER_ATOMIC);
    var code = value_list + '.count(' + value_item + ')';
...
Blockly.Python['lists_pop'] = function (block) {
    var value_list = Blockly.Python.valueToCode(block, 'LIST', Blockly.Python.ORDER_ATOMIC);
    var value_position = Blockly.Python.valueToCode(block, 'POSITION', Blockly.Python.ORDER_ATOMIC);
    var code = value_list + '.pop(' + value_position + ')';
...
Blockly.Python['lists_sort'] = function (block) {
    var value_list = Blockly.Python.valueToCode(block, 'LIST', Blockly.Python.ORDER_ATOMIC);
    var dropdown_reversed = block.getFieldValue('REVERSED');
    var code = value_list + '.sort(reverse=' + dropdown_reversed + ')\n';
