...
Blockly.Python['tuple_isEmpty'] = function (block) {
...
Blockly.Python['tuple_create_empty'] = function (block) {
...
Blockly.Python['tuple_repeat'] = function (block) {
...
Blockly.Python['tuple_cast_to'] = function (block) {
    var value_in = Blockly.Python.valueToCode(block, 'IN', Blockly.Python.ORDER_ATOMIC);
    var code = 'tuple(' + value_in + ')';
    // TODO: Change ORDER_NONE to the correct strength.
    return [code, Blockly.Python.ORDER_NONE];
};

Blockly.Python['tuple_indexOf'] = function (block) {
...
Blockly.Python['tuple_getIndex'] = function (block) {
    ...
    throw 'Unhandled combination (tuple_getIndex).';
};

Blockly.Python['tuple_setIndex'] = function (block) {
    ...
    throw 'Unhandled combination (tuple_setIndex).';
};
...
Blockly.Python['tuple_split'] = function (block) {
    ...
    if (mode == 'SPLIT') {
        ...
        var code = 'tuple(' + value_input + '.split(' + value_delim + '))';
    } else if (mode == 'JOIN') {
